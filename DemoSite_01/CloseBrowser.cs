...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("b6539cae-ecbc-4a20-83e4-683779645881", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'MagentoTesting'.", repo.MagentoTesting.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.MagentoTesting.Self, new Duration(0));
